...
URL:		http://search.cpan.org/dist/Term-InKey/
...
Ten moduł implementuje funkcję Clear() do czyszczenia ekranu i
ReadKey() do odczytywania klawisza na platformach uniksowych i Win32.
W przeciwieństwie do Term::ReadKey nie zawiera kodu XSUB.
